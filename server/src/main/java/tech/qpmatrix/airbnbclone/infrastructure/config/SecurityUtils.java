...
public class SecurityUtils {
    ...
    public static final String CLAIMS_NAMESPACE = "https://qpmatrix.tech/roles";
    ...
    public static User mapOauth2AttributesToUser(Map<String, Object> attributes) {
        ...
        if (attributes.get("email") != null) {
            user.setLastName((String) attributes.get("email"));
    ...
    public static boolean hasCurrentUserAnyOfAuthority(String... authorities) {
    ...
    private static Stream<String> getAuthorities(Authentication authentication) {
        Collection<? extends GrantedAuthority> authorities = authentication instanceof JwtAuthenticationToken
                jwtAuthenticationToken ? extractAuthorityFromClaims(jwtAuthenticationToken.getToken().getClaims()) : authentication.getAuthorities();
